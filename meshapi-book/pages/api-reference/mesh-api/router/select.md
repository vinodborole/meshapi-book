...
resource: https://developers.meshapi.ai/api-reference/mesh-api/router/select
...
1. Source page: https://developers.meshapi.ai/api-reference/mesh-api/router/select
