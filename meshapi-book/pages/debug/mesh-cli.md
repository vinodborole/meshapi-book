...
- Close the Terminal / PowerShell window completely and open a new one, then try `meshapi`again.
- Still failing? Re-run `pipx ensurepath`, then open**another**new window:
...
- `y`
- `a`- **this tool**for the rest of the session.
- `n`
